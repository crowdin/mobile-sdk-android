---
description: Learn how the Crowdin Android SDK keeps your data secure - AWS infrastructure, encrypted transit, and no PII stored about end users.
---
...
- When you use the Crowdin Android SDK CDN, translations are uploaded to Amazon CloudFront to be delivered to the app and speed up the download. Keep in mind that your users download translations without any additional authentication.
