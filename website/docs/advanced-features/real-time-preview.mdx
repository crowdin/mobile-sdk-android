---
description: Preview translations made in the Crowdin Editor directly in your app in real time. Learn how to set up and authorize the Real-Time Preview feature.
---
...
Crowdin authorization is required for the Real-Time Preview feature. Create the connection in your *Activity* or *Fragment* class (e.g., in the *MainActivity* `onCreate` method):
...
- For Jetpack Compose applications, see [Jetpack Compose Real-Time Preview](jetpack-compose).
:::
...
The [OAuth App](https://support.crowdin.com/account-settings/#oauth) redirect URL should match your configured redirect URI:
