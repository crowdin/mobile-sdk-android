---
description: Integrate the Crowdin SDK with Jetpack Compose for real-time translation updates. Learn about configuration, composables, and the Crowdin Gradle plugin.
---
...
# Jetpack Compose Real-Time Preview
