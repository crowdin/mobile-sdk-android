---
description: Use the Crowdin Controls widget for quick access to core SDK features like real-time preview, screenshot capture, and translation reload.
---
...
```groovy
dependencies {
    implementation 'com.github.crowdin.mobile-sdk-android:controls:1.18.1'
}
```

## Initialization

Add this line to your base Activity's `onCreate` method:
...
Call the `destroy` method to hide the control component. You can also do it by tapping the close button:
...
Starting from Android M, the **Display over other apps** permission is required. You will be redirected to the settings screen automatically. To handle the result properly, add the following lines to your Activity class:
