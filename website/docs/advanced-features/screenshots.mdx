---
description: Capture and upload tagged screenshots from your app to Crowdin to give translators visual context. Learn about setup, authorization, and config options.
---
...
:::info
To easily control the Screenshots feature, you can also use the [SDK Controls](/advanced-features/sdk-controls) UI widget.
:::
...
| `withAuthConfig`             | Crowdin authorization config                                            | `withAuthConfig(AuthConfig(client_id, client_secret, redirect_uri, request_auth_dialog))` |
