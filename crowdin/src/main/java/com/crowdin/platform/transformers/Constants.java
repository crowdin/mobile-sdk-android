...
class Constants {
    ...
    static final String ATTRIBUTE_ANDROID_HINT = "android:hint";
    static final String ATTRIBUTE_ENTRIES = "entries";
    static final String ATTRIBUTE_ANDROID_ENTRIES = "android:entries";

    static final String ATTRIBUTE_TEXT_ON = "textOn";
    static final String ATTRIBUTE_ANDROID_TEXT_ON = "android:textOn";
