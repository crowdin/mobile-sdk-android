...
internal class RealTimeUpdateManager(
    ...
    fun openConnection(configuration: Configuration?) {
        dataManager ?: return
        ...
        createConnection(configuration, distributionData)
    }
    ...
    private fun createConnection(
        ...
        ThreadUtils.runInBackgroundPool({
            dataManager.getManifest()?.let {
                ...
                val languageCode = getMatchedCode(configuration, it.languages) ?: return@let
                val listener =
