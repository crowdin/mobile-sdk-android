...
[![Download](https://api.bintray.com/packages/crowdin/mobile-sdk/mobile-sdk-android/images/download.svg?version=1.3.2)](https://bintray.com/crowdin/mobile-sdk/mobile-sdk-android/1.3.2/link)
...
- From JCenter
   ...
   ```groovy
   implementation 'com.crowdin.platform:mobile-sdk:1.3.2'
   ```
